...
<head>
    ...
    <title>Online Hotel Room Reservation System</title>
    ...
    <div class="container py-4 py-xl-5">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <h2>Online Hotel Room Reservation System</h2>
            </div>
        </div>
